...
In its later, canonical DARPA usage, **HACAMS** described the enterprise-level control layer that manages:
* users
* roles
* policies
* domains
...
The HACAMS concept originated in late-1980s and early-1990s DARPA research on trusted computing and MLS system management, and was **later redefined in the mid-1990s** as DARPA shifted its focus toward secure information sharing across classification boundaries.
